    ...
    <div className="product container">
      <ul className="breadcrumb">
        ...
        <li style={{ marginTop: "0.45%", marginLeft: "1%" }}>
          <span style={{ color: "white", fontWeight: 999 }}>
            {productData.name}
          </span>
        </li>
      </ul>
              ...
              <div className="row">
                <div className="col-lg-9 pull-right hidden-xs hidden-sm hidden-md text-center">
                  <img
                    ...
                    height="800"
                    id="productZoom"
                    src="https://livedemo00-opencart.template-help.com/opencart_prod-23526/image/cache/catalog/products/product-22-518x500.png"
                    data-zoom-image="https://livedemo00-opencart.template-help.com/opencart_prod-23526/image/cache/catalog/products/product-22-800x800.png"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="col-sm-6 col-lg-5 product_page-right">
            <div className="general_info product-info">
              ...
              <ul className="list-unstyled product-section">
                <li>
                  <strong>Brand:</strong>
                  <a href="https://livedemo00-opencart.template-help.com/opencart_prod-23526/index.php?route=product/manufacturer/info&amp;manufacturer_id=8">
                    {productData.brand}
                  </a>
                </li>
